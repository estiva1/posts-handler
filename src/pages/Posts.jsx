...
function Posts() {
    ...
    useEffect(() => {
        fetchPosts(limit, page); //функция загрузки постов с сервера
    }, [page, limit]);

    const createPost = (newPost) => {
        setPosts([...posts, newPost]);
        setModal(false); // после создания поста окно закрывается
    };
    ...
    return (
        <div className="App">
            ...
            <PostList remove={removePost} posts={sortedAndSearhedPosts} title="Posts"/>
